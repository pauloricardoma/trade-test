...
/**
  ...
  * It is recommended to export them under the same name as your Actions object,
  * to leverage token merging
  *
  * @example
  *
  * ```ts
  ...
  *      Readonly<{ type: "[core] set name"; payload: string; }> |
  *      Readonly<{ type: "[router] Reload Page"; }>}
